...
function LoadingFallback() {
  return (
    <div className="max-w-lg mx-auto px-6 text-center">
      <div className="w-24 h-24 mx-auto mb-8 rounded-full bg-white/10 flex items-center justify-center animate-pulse">
        <svg className="w-12 h-12 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        </svg>
      </div>
      <div className="h-10 bg-white/10 rounded-lg mb-4 animate-pulse" />
      <div className="h-6 bg-white/5 rounded-lg mb-8 animate-pulse" />
    </div>
  );
}
